          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex gap-2.5 text-sm text-white/70">
                ...
                <a href="tel:092-241-4289" className="hover:text-white transition-colors font-ui">
                  092-241-4289
                </a>
              </li>
              <li className="flex gap-2.5 text-sm text-white/70">
