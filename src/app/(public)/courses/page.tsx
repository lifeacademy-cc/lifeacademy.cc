...
const mockCourses: Course[] = [
  // ประถมศึกษา
  { id: 'p_read_write', name: 'คอร์ส “อ่านออกเขียนได้”', level: 'primary', subject: 'thai', format: 'onsite', price: 1500, max_students: 8, sessions_per_week: 2, enrolled_count: 3, description: 'สำหรับนักเรียนชั้น อนุบาล 3 - ป.1 ที่สะกดคำยังไม่เป็น หรือยังอ่านไม่ออกเขียนไม่ได้และอ่านหนังสือไม่คล่อง', is_active: true, created_at: '' },
  { id: 'p_math_1_3', name: 'คณิตศาสตร์ ประถม 1–3 (ปูพื้นฐาน)', level: 'primary', subject: 'math', format: 'onsite', price: 1500, max_students: 10, sessions_per_week: 2, enrolled_count: 5, description: 'เน้นปูพื้นฐานคณิตศาสตร์และพัฒนาทักษะการคิดคำนวณเบื้องต้นอย่างเป็นระบบ', is_active: true, created_at: '' },
  { id: 'p_eng_1_3', name: 'ภาษาอังกฤษ ประถม 1–3 (Fun with English)', level: 'primary', subject: 'english', format: 'onsite', price: 1500, max_students: 10, sessions_per_week: 2, enrolled_count: 4, description: 'เรียนรู้ภาษาอังกฤษผ่านกิจกรรมแสนสนุก สร้างความคุ้นเคยกับสำเนียงธรรมชาติและคำศัพท์รอบตัว', is_active: true, created_at: '' },
  { id: 'p_math_4_6', name: 'คณิตศาสตร์ ประถม 4–6 (พื้นฐานแข็งแกร่ง)', level: 'primary', subject: 'math', format: 'onsite', price: 1500, max_students: 10, sessions_per_week: 2, enrolled_count: 7, description: 'เสริมพื้นฐานคณิตศาสตร์ สร้างความเข้าใจที่มั่นคงในโจทย์ปัญหาและสมการ ปูทางสู่ ม.ต้น', is_active: true, created_at: '' },
  { id: 'p_eng_4_6', name: 'ภาษาอังกฤษ ประถม 4–6 (Grammar & Communication)', level: 'primary', subject: 'english', format: 'onsite', price: 1500, max_students: 10, sessions_per_week: 2, enrolled_count: 6, description: 'เน้นโครงสร้างไวยากรณ์พื้นฐาน คำศัพท์ และฝึกการสนทนาโต้ตอบอย่างมั่นใจ', is_active: true, created_at: '' },
  { id: 'p_sci_4_6', name: 'วิทยาศาสตร์ ประถม 4–6 (กระบวนการคิด)', level: 'primary', subject: 'science', format: 'onsite', price: 1500, max_students: 10, sessions_per_week: 2, enrolled_count: 5, description: 'เน้นกระบวนการทางวิทยาศาสตร์ การทดลอง และเนื้อหาชีววิทยา เคมี ฟิสิกส์พื้นฐาน', is_active: true, created_at: '' },
  { id: 'p_exam_m1', name: 'คอร์สประถมเตรียมสอบเข้า ม.1 (คณิต-วิทย์-อังกฤษ)', level: 'primary', subject: 'math', format: 'onsite', price: 1800, max_students: 8, sessions_per_week: 2, enrolled_count: 4, description: 'ติวเข้มและตะลุยโจทย์ 3 วิชาหลักเพื่อสอบเข้า ม.1 โรงเรียนดังระดับจังหวัด', is_active: true, created_at: '' },
