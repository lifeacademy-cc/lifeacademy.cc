...
INSERT INTO courses (name, name_th, level, subject, format, price, description, max_students, sessions_per_week) VALUES
  ('คอร์ส “อ่านออกเขียนได้”', 'อ่านออกเขียนได้', 'primary', 'thai', 'onsite', 1500, 'สำหรับนักเรียนชั้น อนุบาล 3 - ป.1 ที่สะกดคำยังไม่เป็น หรือยังอ่านไม่ออกเขียนไม่ได้', 8, 2),
  ('คณิตศาสตร์ ประถม 1–3 (ปูพื้นฐาน)', 'คณิต ประถมต้น', 'primary', 'math', 'onsite', 1500, 'เน้นปูพื้นฐานคณิตศาสตร์และพัฒนาทักษะการคิดคำนวณเบื้องต้นอย่างเป็นระบบ', 10, 2),
  ('ภาษาอังกฤษ ประถม 1–3 (Fun with English)', 'อังกฤษ ประถมต้น', 'primary', 'english', 'onsite', 1500, 'เรียนรู้ภาษาอังกฤษผ่านกิจกรรมแสนสนุก สร้างความคุ้นเคยกับสำเนียงธรรมชาติ', 10, 2),
  ('คณิตศาสตร์ ประถม 4–6 (พื้นฐานแข็งแกร่ง)', 'คณิต ประถมปลาย', 'primary', 'math', 'onsite', 1500, 'เสริมพื้นฐานคณิตศาสตร์ สร้างความเข้าใจที่มั่นคงในโจทย์ปัญหาและสมการ ปูทางสู่ ม.ต้น', 10, 2),
  ('ภาษาอังกฤษ ประถม 4–6 (Grammar & Communication)', 'อังกฤษ ประถมปลาย', 'primary', 'english', 'onsite', 1500, 'เน้นโครงสร้างไวยากรณ์พื้นฐาน คำศัพท์ และฝึกการสนทนาโต้ตอบอย่างมั่นใจ', 10, 2),
  ('วิทยาศาสตร์ ประถม 4–6 (กระบวนการคิด)', 'วิทย์ ประถมปลาย', 'primary', 'science', 'onsite', 1500, 'เน้นกระบวนการทางวิทยาศาสตร์ การทดลอง และเนื้อหาชีววิทยา เคมี ฟิสิกส์พื้นฐาน', 10, 2),
